...
#from modbus_controller import set_motor_speed, set_motor_target_position, stop_motor, start_motor, reset_motor_position
from modbus_controller_2 import ModbusController     # This is the new ModbusController CLASS !!
#from live_plotter import LivePlotter
#from live_plotter2 import LivePlotter
#from live_plotter3 import LivePlotter
#from live_plotter4 import LivePlotter
from live_plotter5 import LivePlotter
...
class ModbusThread(QtCore.QThread):
    ...
    def __init__(self, modbus, frequency, stroke_volume):
        super().__init__()
        self.modbus = modbus  # Pass the ModbusController instance
...
#---------------------------------------- Log Window ---------------------------------
        # Floating log dialog with close button
        ...
        self.log_dialog.mousePressEvent = self.dialog_mouse_press
        self.log_dialog.mouseMoveEvent = self.dialog_mouse_move
        self._drag_pos = None
        ...
        self.log_close_btn.setStyleSheet("""
            QPushButton {
        ...
        self.log_buffer = ""  # Initialize log buffer to store log lines
...
#--------------------------- START/RESET Button ---------------------------------------
        ...
        # Examples of logging colored messages and state indicator color changing
        self.log_message("System initialized", "info")
        self.log_message("Motor started", "done")
        self.log_message("This is a warning ... !", "warning")
        self.log_message("Modbus error: timeout", "error")
        self.update_state_indicator("running")  # or "idle", "error"
...
#------------------------------------- Labels --------------------------------
    ...
    def update_motor_parameters(self):
        print(f"TESTING: Starting ModbusThread with HR={self.heart_rate}, SV={self.stroke_volume}")
